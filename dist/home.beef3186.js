...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"public/js/transitions.js":[function(require,module,exports) {
"use strict";
...
var Fade = /*#__PURE__*/function (_Highway$Transition) {
  ...
  _createClass(Fade, [{
    ...
    value: function _in(_ref) {
      ...
      var nextViewToRender = to.getAttribute('data-router-view');

      if (nextViewToRender === "home") {
        _gsap.TweenMax.to(document.body, {
...
var _default = Fade;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","gsap":"node_modules/gsap/index.js"}],"node_modules/gsap/utils/strings.js":[function(require,module,exports) {
"use strict";
...
},{"./utils/strings.js":"node_modules/gsap/utils/strings.js"}],"public/js/renderers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.HomeRenderer = exports.WorkRenderer = void 0;
...
var slider;
var stuffTL = new _gsap.TimelineMax({
  repeat: -1
});

var WorkRenderer = /*#__PURE__*/function (_Highway$Renderer) {
  _inherits(WorkRenderer, _Highway$Renderer);

  var _super = _createSuper(WorkRenderer);

  function WorkRenderer() {
    _classCallCheck(this, WorkRenderer);

    return _super.apply(this, arguments);
  }

  _createClass(WorkRenderer, [{
    key: "onEnter",
    value: function onEnter() {
      var sliderRef = this.wrap.querySelector('.work__slider');
...
var HomeRenderer = /*#__PURE__*/function (_Highway$Renderer2) {
  _inherits(HomeRenderer, _Highway$Renderer2);

  var _super2 = _createSuper(HomeRenderer);
  ...
  function HomeRenderer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onScroll", function () {
      ...
      if (window.innerHeight + window.scrollY >= document.body.offsetHeight) {
        var arrowBtn = document.querySelector('a.home__arrow');
  ...
  _createClass(HomeRenderer, [{
    ...
    key: "animateStuffWord",
    value: function animateStuffWord() {
      var wordList = ["stuff", "UX/UI", "apps", "email", "branding", "editorial"];
      var stuffRef = document.querySelector('.stuff');
      stuffRef.innerHTML = "";
...
var ScrollSlider = /*#__PURE__*/function () {
  function ScrollSlider(sliderDOM) {
    var _this2 = this;

    _classCallCheck(this, ScrollSlider);

    _defineProperty(this, "scrollEvent", function (e) {
      if (_this2.isScrollDirectionUp(e)) {
        if (!_this2.isAnimating) {
          _this2.scrollAnimation('UP').play();
        }
      } else {
        if (!_this2.isAnimating) {
          _this2.scrollAnimation().play();
        }
      }
    });
    ...
    this.initSlider();
    this.loadEvents();
    this.mainTl = new _gsap.TimelineMax({
      paused: true
    });
  }
  ...
  _createClass(ScrollSlider, [{
    ...
    value: function initSlider() {
      var sliders = this.getSlides();
      sliders.forEach(function (slide) {
        var imageRef = slide.querySelector('.work__picture');
        var infoRef = slide.querySelector('.work__information');

        _gsap.TweenMax.set(imageRef, {
          x: -20,
          autoAlpha: 0
        });

        _gsap.TweenMax.set(infoRef, {
          x: 20,
          autoAlpha: 0
        });
      });
    ...
    key: "getSlideAt",
    value: function getSlideAt(index) {
      var sliders = this.getSlides();
    ...
    value: function initialAnimation() {
      ...
      var tl = new _gsap.TimelineMax();
      var firstSlide = this.getSlideAt(0);
      var imageRef = firstSlide.querySelector('.work__picture');
      var infoRef = firstSlide.querySelector('.work__information');
      var currentSlideColor = firstSlide.getAttribute('data-color');
      var counterContainer = document.querySelector('.work__counter-container');
      tl.add('scene-1').to(document.body, {
        backgroundColor: currentSlideColor,
        duration: .6,
        ease: _gsap.Power0.easeInOut,
        onStart: function onStart() {
          _this3.toggleIsMenuWhite(firstSlide);
        }
      }, 'scene-1').to(imageRef, {
        x: 0,
        autoAlpha: 1,
      ...
      }, 'scene-1').to(counterContainer, {
        autoAlpha: 1,
        duration: .6
      });
    }
  }, {
    key: "isScrollDirectionUp",
    value: function isScrollDirectionUp(e) {
      if (e.wheelData) {
    ...
    value: function scrollAnimation() {
      ...
      var currentSlide = this.getSlideAt(this.currentSlideIndex);
      var nextSlideIndex;
      ...
      var nextSlide = this.getSlideAt(nextSlideIndex);
      var currentSlideImage = currentSlide.querySelector('.work__picture');
      var currentSlideInfo = currentSlide.querySelector('.work__information');
      var nextSlideImage = nextSlide.querySelector('.work__picture');
      var nextSlideInfo = nextSlide.querySelector('.work__information');
      var nextSlideColor = nextSlide.getAttribute('data-color');
      var isNextSlideDark = nextSlide.getAttribute('data-is-dark');
      var isNextSlideMenuWhite = nextSlide.getAttribute('data-is-menu-white');
      var slideIndicatorRef = document.querySelector('.work__current');
      var counterContainer = document.querySelector('.work__counter-container');
      this.mainTl.clear();
      this.mainTl.add('scene-1').to(currentSlideImage, {
        x: -100,
        autoAlpha: 0,
        duration: .6,
        ease: _gsap.Power0.easeInOut,
      ...
      }, 'scene-1').to(currentSlideInfo, {
        x: 100,
        autoAlpha: 0,
        duration: .6,
        ease: _gsap.Power0.easeInOut
      }, 'scene-1').to(slideIndicatorRef, {
        autoAlpha: 0,
        y: -10,
        duration: .6,
        onComplete: function onComplete() {
          ...
          if (direction === 'DOWN') {
            _this4.nextSlideIndex();
          } else {
            _this4.prevSlideIndex();
          }
          ...
          _this4.toggleIsMenuWhite(nextSlide);

          slideIndicatorRef.innerHTML = _this4.currentSlideIndex + 1;
        }
      }).add('nextslide-scene').to(slideIndicatorRef, {
        autoAlpha: 1,
        y: 0,
        duration: .6
      }).to(document.body, {
        ...
        duration: .8,
        ease: _gsap.Power0.easeInOut
      }, 'nextslide-scene').to(nextSlideImage, {
        x: 0,
        autoAlpha: 1,
        duration: .6
      }, 'nextslide-scene').to(nextSlideInfo, {
        x: 0,
        autoAlpha: 1,
        duration: .6,
        ease: _gsap.Power0.easeInOut,
...
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","gsap":"node_modules/gsap/index.js","gsap/TextPlugin":"node_modules/gsap/TextPlugin.js"}],"public/js/home.js":[function(require,module,exports) {
"use strict";
...
var H = new _highway.default.Core({
  renderers: {
    work: _renderers.WorkRenderer,
    home: _renderers.HomeRenderer
  },
  transitions: {
    home: _transitions.default,
    default: _transitions.default
  }
});
window.hwInstance = H; // Menu toggle 

var menuBtn = document.getElementsByClassName('header__btn-toggle')[0];
menuBtn.addEventListener('click', function () {
  document.body.classList.toggle('is-menu-open');
});
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","./transitions":"public/js/transitions.js","./renderers":"public/js/renderers.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","public/js/home.js"], null)
//# sourceMappingURL=/home.beef3186.js.map